...
%define sum		Library for TrueType fonts
%define sum_ru		Библиотека для обработки TrueType шрифтов
%define maintainer	Gleb Golubitsky (Sectoid) <Sectoid_GGV@mail.ru>
%define name		libfreetype
%define altname		freetype
%define ver		2.1.7
%define rel		los1
...
Patch0:		%{altname}-%{version}-bytecode-interpreter.patch
...
%description
The %{name} package contains a stream oriented C library to display 
TrueType fonts.

%description -l ru_RU.KOI8-R
Пакет %{name} содержит C-ориентированную библиотеку для обработки 
TrueType шрифтов.
